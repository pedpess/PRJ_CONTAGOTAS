...
public class MediaGastosDao extends AbstractDao<MediaGastos, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Deleted = new Property(3, String.class, "deleted", false, "DELETED");
    };
    ...
    public MediaGastos readEntity(Cursor cursor, int offset) {
        MediaGastos entity = new MediaGastos( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // deleted
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, MediaGastos entity, int offset) {
        ...
        entity.setDeleted(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
